...
var PredicateOld = compiler.Predicate;
var Group = compiler.Group;
var Map = compiler.Map;
var utils = xjst.utils;

function aop(self, constructor, superConstructor) {

  function wrap(method, args) {
    var timerBegin = process.hrtime(),
        res = constructor.super_.prototype[method].apply(self, args),
  ...
  //   var args = arguments;
  //   return wrap('render', args);
  // };

  Object.keys(superConstructor.prototype).forEach(function (method) {
    console.log(method);
...
function Predicate(compiler, expr, value) {
  PredicateOld.call(this, compiler, expr, value);
  aop(this, Predicate, PredicateOld);
}
util.inherits(Predicate, PredicateOld);

// Predicate.prototype.render = function () {
//   var t0 = process.hrtime();
//   var res = Predicate.super_.prototype.render.apply(this, arguments);
//   var tDiff = process.hrtime(t0);
//   console.log('Rendered a predicate in %d nanoseconds', tDiff[0] * 1e9 + tDiff[1]);
//   return res;
// };
