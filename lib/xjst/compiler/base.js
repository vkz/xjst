...
// [ predicate-ast ] -> [ new Predicate(this, lhs-expr, rhs-value) ]
Compiler.prototype.transformTemplates = function transformTemplates(template) {
  ...
  predicates = predicates.map(function(pred) {
    ...
    // template(function() { body; })      => template(function() { body; }.call(this)) to ensure 'this' refers to Compiler instance
  ...
  return new Template(this, predicates, body); // see 'entities/predicate.js'
};
