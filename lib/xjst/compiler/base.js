...
// vkz
var withAspect = require("../aspect").withAspect,
...
var Template = withAspect(compiler.Template);
var Predicate = withAspect(compiler.Predicate);
...
exports.Compiler = Compiler = withAspect(Compiler);
